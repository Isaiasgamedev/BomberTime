...
public class Player : MonoBehaviour
{
    ...
    [Header("Chip Keys Control")]

    public int ChipKeys;
    public int ChipkeysControl;
    

    [Header("Labels COntrol")]
    ...
    public IEnumerator respawn_wait()
    {
        yield return new WaitForSeconds(3);
        respawning = false;
    }

    public IEnumerator gameover_wait()
    {
    ...
    public IEnumerator dmg_animation()
    {
